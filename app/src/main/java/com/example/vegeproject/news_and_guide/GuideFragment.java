...
public class GuideFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.addItem("채식주의가 뭔가요?", "The definition of vegan",
                ...
                ,R.drawable.carrot,R.drawable.vegan_definition);
        ...
        adapter.addItem("비건에도 단계가?", "6 stages of vegan"," 비건은 총 6단계로 이루어져 있습니다." +
                ...
                "채식을 시작할 때는 본인의 체질과 건강을 고려하여 단계를 골라 실천하는 것이 좋습니다.",R.drawable.green_apple,R.drawable.vegan_stage);
        ...
        adapter.addItem("비건을 하는 이유는?" , "Why do we eat vegetables",
                " 크게 환경적인 이유와 윤리적인 이유로 나눌 수 있습니다."+
                        ...
                        "채식주의자들은 '살아있는 생명을 죽일 권리는 없다'는 동물권을 주장하면서 윤리적인 이유로 육식을 거부합니다.",R.drawable.radish,R.drawable.eco);
        ...
        adapter.addItem("비건의 장점은?", "The advantage of vegan",
                ...
                "아토피와 같은 피부질환도 줄일 수 있다고 합니다. 채식주의자들은 육식을 하는 사람들에 비해 수명이 길다는 연구 결과도 있습니다." ,R.drawable.tomato,R.drawable.nature);
        return root;
    }
}
