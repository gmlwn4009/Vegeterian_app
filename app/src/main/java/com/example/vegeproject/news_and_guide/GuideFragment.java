    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.addItem("채식주의가 뭔가요?", "The definition of vegetarianism",
                " 1944년, 유제품을 먹지 않는 채식주의자에 대한 개념을 탐구하던 중 beginning과 vegetarian을 결합해 vegan이라는 용어를 제시했습니다." +
                        ...
                        "일부 엄격하지 않은 채식의 경우에는 동물의 고기를 제외한 일부의 동물성 음식을 먹는 경우도 있습니다.", R.drawable.icon_definition);

        adapter.addItem("채식의 단계", "6 stages of vegetarian",
                " 채식은 총 6단계로 이루어져 있습니다." +
                        "상황에 따라 육류를 허용하는 플렉시테리언부터 육류를 아예 섭취하지 않는 비건까지 채식의 종류는 다양합니다." +
                        "각각의 비건 단계는 육류, 가금류, 해산물, 달걀, 유제품, 채소, 이렇게 6가지의 카테고리로 나누어져 있습니다. " +
                        "채식을 시작할 때는 본인의 체질과 건강을 고려하여 단계를 골라 실천하는 것이 좋습니다.", R.drawable.icon_stage);
        ...
        adapter.addItem("채식을 하는 이유" , "Why do we eat vegetables",
                " 크게 환경적인 이유와 윤리적인 이유로 나눌 수 있습니다."+
                        ...
                        "채식주의자들은 '살아있는 생명을 죽일 권리는 없다'는 동물권을 주장하면서 윤리적인 이유로 육식을 거부합니다.", R.drawable.icon_reason);

        adapter.addItem("채식의 장점", "The advantage of vegetarian diet",
                " 채식주의자들은 심장병이나 당뇨, 고혈압 등의 각종 성인병에 걸릴 확률이 낮습니다. " +
                        "채식을 하게 되면 포화지방과 콜레스테롤의 섭취가 줄어 적정 체중을 유지할 수 있고 비만을 막을 수 있습니다. " +
                        "아토피와 같은 피부질환도 줄일 수 있다고 합니다. 채식주의자들은 육식을 하는 사람들에 비해 수명이 길다는 연구 결과도 있습니다." , R.drawable.icon_advantage);

        adapter.addItem("채식 시 주의점","caution when you start vegentarian diet",
                " 정제된 곡류, 고구마, 감자 등 열량이 높은 식물성 식품은 심장 질환이나 당뇨병을 유발하지 않을 정도로" +
                        ...
                        "결핍된 성분들은 콩을 통해서 단백질을 채우고, 영양제를 통해 비타민을 보충하는 방법이 있습니다.", R.drawable.icon_vitamin);
        ...
        adapter.addItem("다양한 비건 분야","Various vegan fields",
                " 동물실험을 거치지 않은 원재료를 사용해 제품을 만드는 과정이 핵심인 비거니즘을 모토로" +
                        ...
                        " 이미 여러 방면에서 비거니즘은 실천되고 있습니다", R.drawable.icon_cosmetic);
