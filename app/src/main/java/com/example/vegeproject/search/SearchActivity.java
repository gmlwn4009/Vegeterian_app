    ...
    //최근 검색기록 클릭시 검색되는...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // 최근 검색어 클릭시 상단으로 올림
                array_list.remove(searchItem);
                set.remove(searchItem);
                createTextview(searchItem);
            }
        });
    ...
    private void createTextview(String searchItem) {
        ...
        if(array_list.size() >= 10) {
           ...
           set.clear();
            ...
            for(int i= 0; i < 9;i++)
                set.add(array_list.get(i).toString());
        ...
        Collections.reverse(array_list);
            ...
            arrayAdapter = new ArrayAdapter(SearchActivity.this, R.layout.searchlog_card, R.id.log, array_list);
            listView.setAdapter(arrayAdapter);

            setStringArrayPref(SearchActivity.this, "RECENTSEARCH", array_list);
        }
